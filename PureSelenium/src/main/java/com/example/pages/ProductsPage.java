...
public class ProductsPage extends BasePage {
    ...
    @FindBy(xpath = "//div[contains(@class, 'single-products')]//div[contains(@class, 'overlay-content')]//a[@class='btn btn-default add-to-cart']")
    ...
    public void continueShopping() {
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(continueShoppingButton.getBy()));
        wait.until(ExpectedConditions.elementToBeClickable(continueShoppingButton.getBy()));
